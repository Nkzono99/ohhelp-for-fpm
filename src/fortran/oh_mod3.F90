...
module ohhelp3
    ...
    interface
        subroutine oh3_init_(sdid, nspec, maxfrac, nphgram, totalp, &
            ...
            integer(c_int), intent(inout) :: sdoms
            integer(c_int), intent(in)    :: scoord
            integer(c_int), intent(in)    :: nbound
            integer(c_int), intent(in)    :: bcond
            integer(c_int), intent(inout) :: bounds
            integer(c_int), intent(in)    :: ftypes
            integer(c_int), intent(in)    :: cfields
            integer(c_int), intent(in)    :: ctypes
            integer(c_int), intent(out)   :: fsizes
